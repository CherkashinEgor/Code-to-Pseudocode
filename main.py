...
def main():
    ...
    # Load data
    train_dataloader, val_dataloader, test_dataloader = create_dataloaders(batch_size=128)
    ...
    for nhead in nheads:
        for num_layer in num_layers:
            ...
            generate_test_translations(model, test_dataloader, device, f"nhead_{nhead}_num_layer_{num_layer}", all_generations)
